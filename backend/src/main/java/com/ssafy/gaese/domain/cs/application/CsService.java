...
public class CsService {
    ...
    public void gameStart(CsRoomDto roomDto) throws InterruptedException {
...
//            게임 시작하고 5초 타이머
        ...
        // 방 삭제
        csRoomService.deleteRoom(saved.getCode());
        res.put("msg", "end");
        simpMessagingTemplate.convertAndSend("/cs/room/"+roomDto.getCode(),res);
    ...
    public void gameEnd(CsRoomDto roomDto,List<CsProblem> randomProblem){
        ...
        entryList.sort((Comparator<? super Map.Entry<Long, Long>>) Map.Entry.comparingByValue().reversed());
